...
public class MSTAndTopologicalSortExample {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
      "MST total weight (Kruskal - array): " + kruskalMSTArray(edges, 4)
    );
    System.out.println(
      "MST total weight (Kruskal - DSU rank): " + kruskalMSTByRank(edges, 4)
    );
    System.out.println(
      "MST total weight (Kruskal - DSU size): " + kruskalMSTBySize(edges, 4)
    );
    ...
    System.out.println(
      "Topological order (BFS / Kahn): " + topologicalSortBFS(graph)
    );
  ...
  // -----------------------  MST (Kruskal, Prim) -----------------------
  //---------------------------------------------------------------------------
  // Kruskal's algorithm using union-find (disjoint set) to detect cycles.
  ...
  // This is more efficient than the simple array-based union-find.
  public static int kruskalMSTByRank(List<Edge> edges, int vertices) {
    // Step 1: Sort edges by ascending weight.
    edges.sort(Comparator.comparingInt(e -> e.weight));
  ...
  //---------------------------------------------------------------------------
  //  -------Kruskal's algorithm using union-find with path compression and union by size.
